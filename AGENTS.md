...
- **100% Vitest & TypeScript Passing**: Full 72-test suite passing across engine, validation, lineage, glossary, and accessibility — including the whole-library sweep of all 180 plays.
